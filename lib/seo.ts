...
export function generateSEO(props: SEOProps): Metadata {
  ...
  return {
    title: title ? `${title} | CodeReverb` : undefined,
    description,
    keywords: allKeywords,
    openGraph: {
      title: title
        ? `${title} | CodeReverb`
        : "CodeReverb - AI-Powered Code Review Platform",
      description:
        description ||
...
export const seoConfigs = {
  ...
  contact: {
    ...
    keywords: ["contact CodeReverb", "support", "technical support"],
  },
  faq: {
    ...
    keywords: ["FAQ", "frequently asked questions", "CodeReverb help"],
  },
  privacy: {
  ...
  dashboard: {
    title: "Dashboard",
    description:
      "Access your CodeReverb dashboard to manage repositories, view analytics, and monitor AI-powered code reviews.",
    noIndex: true,
  },
} as const;
